...
$sql = "INSERT INTO user_list (first_name, last_name, phone, email, other_info, email_verification) VALUES('" . $inData["first_name"] "', '" . $inData["last_name"] . "', '". $inData["phone"]. " ', '" . $inData["email"] . "'";
